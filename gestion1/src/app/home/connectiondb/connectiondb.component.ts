...
@Component({
  selector: 'app-connectiondb',
  templateUrl: './connectiondb.component.html',
  styleUrls: ['./connectiondb.component.css']
})
export class ConnectiondbComponent implements OnInit {
  term:String;
  tab
  documents:any={
    idConn:'',
